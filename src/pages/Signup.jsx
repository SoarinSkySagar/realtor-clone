      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            {showPassword ? (<AiFillEyeInvisible className='absolute right-3 top-3 text-xl cursor-pointer' onClick={()=>setShow((prevState)=>!prevState)}/>):(<AiFillEye className='absolute right-3 top-3 text-xl cursor-pointer' onClick={()=>setShow((prevState)=>!prevState)}/>)}
            </div>
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
              <p>Have an account? <Link to="/login" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out'>Sign in</Link></p>
            </div>
